...
public class MinimumCostOfRopes {
    ...
    // Approach: Using minHeap to store the elements and then picking the top two elements and adding to the total cost and pushing the sum of those two back into the minHeap
    // TC => O(NLogN)
    // SC => O(N)
